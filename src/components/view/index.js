// Export all view components for easy importing
...
export { default as WebsiteLink } from './WebsiteLink.vue'
export { default as LogoDisplay } from './LogoDisplay.vue'
export { default as AccountNumber } from './AccountNumber.vue'

// Common icons for cards
export const CARD_ICONS = {
  ...
  BANK: "M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M10.5 3L12 2l1.5 1H21v6H3V3h7.5z",
...
export const formatDate = (dateString, locale = 'en-ZA') => {
